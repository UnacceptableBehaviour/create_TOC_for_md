...
The TOC generated by create_TOC_for_md.py uses the same headings and creates set of indented contents links at the top of the file.
...
![latex md](https://github.com/UnacceptableBehaviour/create_TOC_for_md/blob/main/tex/formula_latex.png)  
